export default {
  ...
  "add.aboutCorrection":
    ...
    "проверенную словарную форму из разбора. Если ввод похож на опечатку, карточка не создаётся, " +
    "пока вы не выберете написание: под разбором появится кнопка ✏️ с " +
    "исправленным написанием — разбор повторится для него — и кнопка ✓, которая просит " +
    "разобрать ваше написание как слово. Карточка появляется только после выбора, и всегда " +
    "по тому написанию, которое разбирали.",
  ...
  "card.spelling": "✏️ похоже на опечатку — карточки пока нет",
  "card.spellingRefused": "⚠️ модель не разбирает это написание как слово",
