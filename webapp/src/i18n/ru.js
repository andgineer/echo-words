export default {
  ...
  "add.notInDictionary":
    "Слова «{word}» нет ни в одном словаре. Это может быть редкое слово, неожиданная форма или несуществующее слово — карточка всё равно создана.",
  "add.findUsage": "Найти реальные употребления",
  "add.usageSearching": "Ищу…",
  "add.usageUnavailable": "Поиск употреблений сейчас не отвечает.",
  "add.usageNone":
    "«{word}» не встречается в Википедии на этом языке ни разу. Все проверенные выдуманные слова вели себя так же.",
  "add.usageFound.one": "«{word}» встречается в {count} статье — значит, кто-то это пишет:",
  "add.usageFound.few": "«{word}» встречается в {count} статьях — значит, кто-то это пишет:",
  "add.usageFound.many": "«{word}» встречается в {count} статьях — значит, кто-то это пишет:",
  "add.usageFound.other": "«{word}» встречается в {count} статьях — значит, кто-то это пишет:",
  "add.usageAll": "Посмотреть все",
