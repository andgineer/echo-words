export default {
  ...
  "add.detailSection": "Полная статья",
  "add.detailGoto": "Перейти к полной статье",
  "add.paidAnswer": "Запросить карточку у платной модели",
  "add.deleteCard": "Удалить из Anki",
  "add.noCard": "Карточки в Anki нет",
  "add.cardNotMade": "Карточку не удалось создать",
  "add.removeFromFeed": "Убрать из ленты",
  "add.removedFromFeed": "Убрано из ленты — в Anki ничего не изменилось.",
  "add.undoRemove": "Вернуть",
  ...
  "add.speakWord": "Озвучить",
  "add.speakText": "Озвучить весь текст",
  "add.pauseAudio": "Пауза",
