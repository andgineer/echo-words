export default {
  ...
  "add.detail": "In depth",
  "add.detailSection": "The full entry",
  "add.detailGoto": "Go to the full entry",
  "add.paidAnswer": "Ask the paid model for a card",
  "add.deleteCard": "Delete from Anki",
  "add.noCard": "No card in Anki",
  "add.cardNotMade": "The card could not be made",
  "add.removeFromFeed": "Remove from the list",
  "add.removedFromFeed": "Removed from the list — nothing changed in Anki.",
  "add.undoRemove": "Undo",
