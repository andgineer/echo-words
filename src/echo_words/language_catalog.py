...
CATALOG: tuple[CatalogLanguage, ...] = (
    ...
    CatalogLanguage("pt", "Português", "Portuguese", "португальский", _LATIN, recordings="Pt-br"),
    ...
    CatalogLanguage("es", "Español", "Spanish", "испанский", _LATIN, recordings="Es-am-lat"),
    ...
    CatalogLanguage("tr", "Türkçe", "Turkish", "турецкий", _LATIN),
