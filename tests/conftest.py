...
_DEFAULT_BEHAVIOR_BY_FILE: dict[str, tuple[str, str, str | None]] = {
    ...
    "test_e2e_readme_screenshots.py": (_PLATFORM, "Health and deployment", "README screenshots"),
    ...
    "test_llmbroker_contract.py": (_VOCABULARY, "LLM cascade", "llmbroker contract"),
    ...
    "test_attestation.py": (_VOCABULARY, "Answer delivery", "Attested wording"),
    "test_lexicon.py": (_VOCABULARY, "Answer delivery", "Attested wording"),
